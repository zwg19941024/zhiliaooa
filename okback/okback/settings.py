"""
Django settings for okback project.
...
SECRET_KEY = 'django-insecure-%&es$ldwe4ycgbmsej-9oe)&k@1ospwj-)!!swnpe#yqwy7oq^'
...
WSGI_APPLICATION = 'okback.wsgi.application'
